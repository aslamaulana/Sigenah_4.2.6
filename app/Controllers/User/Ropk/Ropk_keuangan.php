...
class Ropk_keuangan extends BaseController
{
	...
	public function __construct()
	{
		...
		$this->ropk_kegiatan_sub = new Model_ropk_keuangan_kegiatan_sub();
	...
	public function grafik()
	{
		if (has_permission('User')) :
			...
			// dd($data);
			echo view('user/Ropk/ropk_keuangan_grafik', $data);
		else :
			throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
		endif;
	}
	public function keuangan_add($id)
	{
		if (has_permission('User')) :
			$data = [
				'gr' => 'ropk',
			...
			echo view('user/Ropk/ropk_keuangan_add', $data);
		else :
			throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
		endif;
	}
	public function keuangan_create()
	{
		if (has_permission('User')) :
			...
			return redirect()->to(base_url() . '/user/ropk/ropk_keuangan/keuangan/' . $this->request->getVar('id'));
		else :
			throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
		endif;
	}
	public function keuangan_edit($id, $sub = '')
	{
		if (has_permission('User')) :
			$data = [
				'gr' => 'ropk',
			...
			echo view('user/Ropk/ropk_keuangan_edit', $data);
		else :
			throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
		endif;
	}
	public function keuangan_update()
	{
		if (has_permission('User')) :
			...
			session()->setFlashdata('pesan', 'Data berhasil di simpan.');
			return redirect()->to(base_url() . '/user/ropk/ropk_keuangan/keuangan/' . $this->request->getVar('id_sub'));
		else :
			throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
		endif;
	}
	...
	---------------------------------------Data RKPD Sub Kegiatan-----------------------------------
	---------------------------------------Data RKPD Sub Kegiatan-------------------------------- */
	public function ropk_keuangan_kegiatan_sub_edit($id)
	{
		if (has_permission('User')) :
			$data = [
				'gr' => 'ropk',
			...
			echo view('user/Ropk/ropk_keuangan_kegiatan_sub_edit', $data);
		else :
			throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
		endif;
	}
	public function ropk_keuangan_kegiatan_sub_update()
	{
		if (has_permission('User')) :
			if (!$this->validate([
			...
			$this->ropk_kegiatan_sub->save([
				'id_ropk_keuangan_rkpd_kegiatan_sub' => $this->request->getVar('id'),
	...
	public function simpanExcel()
	{
		...
		foreach ($data as $x => $row) {
			...
			$this->ropk_keuangan->insert($simpandata);
			session()->setFlashdata('pesan', 'Data berhasil di simpan.');
			// }
		}
	...
	public function export_edit()
	{
		...
		foreach ($data as $row) {
			$spreadsheet->setActiveSheetIndex(0)
				->setCellValue('A' . $column, $row['id_ropk_keuangan'])
	...
	public function simpanExcel_edit()
	{
		...
		foreach ($data as $x => $row) {
			...
			$id = [
				'tahun' => $_SESSION['tahun'],
				'id_ropk_keuangan' => $row[0],
				'opd_id' => user()->opd_id,
			];
			$this->ropk_keuangan->set($simpandata)->where($id)->update();
