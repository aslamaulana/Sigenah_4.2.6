...
class Model_opd_kegiatan_sub extends Model
{
	...
	public function Kegiatan()
	{
		return $this->db->table('tb_rkpd_kegiatan_sub')
			...
			->getWhere(['tb_rkpd_kegiatan_sub.opd_id' => user()->opd_id, 'tb_rkpd_kegiatan_sub.tahun' => $_SESSION['tahun']])->getResultArray();
	}
	public function Kegiatan_sub()
	{
		return $this->db->table('tb_rkpd_kegiatan_sub')
			->distinct('set_sub_kegiatan_90.id_sub_kegiatan, tb_rkpd_kegiatan_sub.rkpd_kegiatan_sub_n')
			->select('set_sub_kegiatan_90.id_sub_kegiatan, tb_rkpd_kegiatan_sub.rkpd_kegiatan_sub_n')
			->join('set_sub_kegiatan_90', 'tb_rkpd_kegiatan_sub.rkpd_kegiatan_sub_n = set_sub_kegiatan_90.sub_kegiatan', 'LEFT')
			->getWhere(['tb_rkpd_kegiatan_sub.opd_id' => user()->opd_id, 'tb_rkpd_kegiatan_sub.tahun' => $_SESSION['tahun']])->getResultArray();
	}
