...
<div class="card-body">
	...
	<?php $progres2 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'], 'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b2'])->getRowArray();
	...
	<?php $progres3 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'], 'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b3'])->getRowArray();
	...
	<?php $progres4 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'], 'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b4'])->getRowArray();
	...
	<?php $progres5 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],	'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b5'])->getRowArray();
	...
	<?php $progres6 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],	'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b6'])->getRowArray();
	...
	<?php $progres8 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],	'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b8'])->getRowArray();
	...
	<?php $progres9 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],	'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b9'])->getRowArray();
	...
	<?php $progres10 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],	'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b10'])->getRowArray();
	...
	<?php $progres11 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],	'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b11'])->getRowArray();
	...
	<?php $progres12 = $db->table('tb_simonela_progres')->select('bulan_lapor, created_at')->selectsum('realisasi_keu')->selectsum('realisasi_fisik')->getWhere(['kegiatan' => $DT['rkpd_kegiatan_n'], 'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'], 'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],	'opd_id' => $_SESSION['opd_set'], 'tahun' => $_SESSION['tahun'], 'perubahan' => $_SESSION['perubahan'], 'bulan' => 'b12'])->getRowArray();
