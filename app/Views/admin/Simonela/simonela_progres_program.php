...
<div class="card-body">
	...
	<table id="example1" class="table table-bordered display nowrap table-sm">
		...
		$kegiatan = $db->table('tb_ropk_keuangan_rkpd_kegiatan_sub')
			->select('tb_rkpd_kegiatan.rkpd_kegiatan_n')
			->distinct('tb_rkpd_kegiatan.rkpd_kegiatan_n')
			->join('tb_rkpd_kegiatan', 'tb_ropk_keuangan_rkpd_kegiatan_sub.rkpd_kegiatan_n = tb_rkpd_kegiatan.rkpd_kegiatan_n AND tb_ropk_keuangan_rkpd_kegiatan_sub.opd_id = tb_rkpd_kegiatan.opd_id AND	tb_ropk_keuangan_rkpd_kegiatan_sub.tahun = tb_rkpd_kegiatan.tahun AND tb_ropk_keuangan_rkpd_kegiatan_sub.perubahan = tb_rkpd_kegiatan.perubahan', 'LEFT')
			->getWhere([
				'tb_rkpd_kegiatan.rkpd_program_n' => $nm_program,
		...
		foreach ($kegiatan as $rol) :
			$vowels = array(" ", ",", ".", "(", ")", "/", "&", ":");
			$id_keg[] = str_replace($vowels, '', $rol['rkpd_kegiatan_n']);
			dd($id_keg);
		?>
			...
			foreach ($qu as $row) :
				$id_sub = $row['id_ropk_keuangan_rkpd_kegiatan_sub'] . $id_keg;
			?>
				...
				try {
					isset($progres1['realisasi_keu']) ? $real1[$id_keg][] = ($progres1['realisasi_keu'] / $bb1[$id_sub]) * 100 : $real1[$id_keg][] = '0';
				} catch (DivisionByZeroError $e) {
					$real1[$id_keg][] = '0';
				}

				try {
					isset($progres1['realisasi_fisik']) ? $realf1[$id_keg][] = number_format(round(($progres1['realisasi_fisik'] / $fbb1[$id_sub]) * 100, 2), 2, ',', '.') : $realf1[$id_keg][] = '0';
				} catch (DivisionByZeroError $e) {
					$realf1[$id_keg][] = '0';
				}
				?>
				...
				<tr>
					...
					try {
						isset($realisasi2['realisasi_keu']) ? $real2[$id_keg][] = round(($realisasi2['realisasi_keu'] / $bb2[$id_sub]) * 100, 2) : $real2[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real2[$id_keg][] = '0';
					}

					try {
						isset($realisasi2['realisasi_fisik']) ? $realf2[$id_keg][] = number_format(round(($realisasi2['realisasi_fisik'] / $fbb2[$id_sub]) * 100, 2), 2, ',', '.') : $realf2[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf2[$id_keg][] = '0';
					}
					?>
				...
				<tr>
					...
					try {
						isset($realisasi3['realisasi_keu']) ? $real3[$id_keg][] = round(($realisasi3['realisasi_keu'] / $bb3[$id_sub]) * 100, 2) : $real3[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real3[$id_keg][] = '0';
					}

					try {
						isset($realisasi3['realisasi_fisik']) ? $realf3[$id_keg][] = number_format(round(($realisasi3['realisasi_fisik'] / $fbb3[$id_sub]) * 100, 2), 2, ',', '.') : $realf3[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf3[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi4['realisasi_keu']) ? $real4[$id_keg][] = round(($realisasi4['realisasi_keu'] / $bb4[$id_sub]) * 100, 2) : $real4[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real4[$id_keg][] = '0';
					}

					try {
						isset($realisasi4['realisasi_fisik']) ? $realf4[$id_keg][] = number_format(round(($realisasi4['realisasi_fisik'] / $fbb4[$id_sub]) * 100, 2), 2, ',', '.') : $realf4[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf4[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi5['realisasi_keu']) ? $real5[$id_keg][] = round(($realisasi5['realisasi_keu'] / $bb5[$id_sub]) * 100, 2) : $real5[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real5[$id_keg][] = '0';
					}

					try {
						isset($realisasi5['realisasi_fisik']) ? $realf5[$id_keg][] = number_format(round(($realisasi5['realisasi_fisik'] / $fbb5[$id_sub]) * 100, 2), 2, ',', '.') : $realf5[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf5[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi6['realisasi_keu']) ? $real6[$id_keg][] = round(($realisasi6['realisasi_keu'] / $bb6[$id_sub]) * 100, 2) : $real6[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real6[$id_keg][] = '0';
					}

					try {
						isset($realisasi6['realisasi_fisik']) ? $realf6[$id_keg][] = number_format(round(($realisasi6['realisasi_fisik'] / $fbb6[$id_sub]) * 100, 2), 2, ',', '.') : $realf6[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf6[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi7['realisasi_keu']) ? $real7[$id_keg][] = round(($realisasi7['realisasi_keu'] / $bb7[$id_sub]) * 100, 2) : $real7[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real7[$id_keg][] = '0';
					}

					try {
						isset($realisasi7['realisasi_fisik']) ? $realf7[$id_keg][] = number_format(round(($realisasi7['realisasi_fisik'] / $fbb7[$id_sub]) * 100, 2), 2, ',', '.') : $realf7[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf7[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi8['realisasi_keu']) ? $real8[$id_keg][] = round(($realisasi8['realisasi_keu'] / $bb8[$id_sub]) * 100, 2) : $real8[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real8[$id_keg][] = '0';
					}

					try {
						isset($realisasi8['realisasi_fisik']) ? $realf8[$id_keg][] = number_format(round(($realisasi8['realisasi_fisik'] / $fbb8[$id_sub]) * 100, 2), 2, ',', '.') : $realf8[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf8[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi9['realisasi_keu']) ? $real9[$id_keg][] = round(($realisasi9['realisasi_keu'] / $bb9[$id_sub]) * 100, 2) : $real9[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real9[$id_keg][] = '0';
					}

					try {
						isset($realisasi9['realisasi_fisik']) ? $realf9[$id_keg][] = number_format(round(($realisasi9['realisasi_fisik'] / $fbb9[$id_sub]) * 100, 2), 2, ',', '.') : $realf9[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf9[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi10['realisasi_keu']) ? $real10[$id_keg][] = round(($realisasi10['realisasi_keu'] / $bb10[$id_sub]) * 100, 2) : $real10[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real10[$id_keg][] = '0';
					}

					try {
						isset($realisasi10['realisasi_fisik']) ? $realf10[$id_keg][] = number_format(round(($realisasi10['realisasi_fisik'] / $fbb10[$id_sub]) * 100, 2), 2, ',', '.') : $realf10[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf10[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi11['realisasi_keu']) ? $real11[$id_keg][] = round(($realisasi11['realisasi_keu'] / $bb11[$id_sub]) * 100, 2) : $real11[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real11[$id_keg][] = '0';
					}

					try {
						isset($realisasi11['realisasi_fisik']) ? $realf11[$id_keg][] = number_format(round(($realisasi11['realisasi_fisik'] / $fbb11[$id_sub]) * 100, 2), 2, ',', '.') : $realf11[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf11[$id_keg][] = '0';
					}
					?>
					...
					try {
						isset($realisasi12['realisasi_keu']) ? $real12[$id_keg][] = round(($realisasi12['realisasi_keu'] / $bb12[$id_sub]) * 100, 2) : $real12[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$real12[$id_keg][] = '0';
					}

					try {
						isset($realisasi12['realisasi_fisik']) ? $realf12[$id_keg][] = number_format(round(($realisasi12['realisasi_fisik'] / $fbb12[$id_sub]) * 100, 2), 2, ',', '.') : $realf12[$id_keg][] = '0';
					} catch (DivisionByZeroError $e) {
						$realf12[$id_keg][] = '0';
					}
					?>
				...
				<?php
				try {
					$ggggggggg[] = array_sum($real1[$id_keg]) / count($real1[$id_keg]);
				} catch (DivisionByZeroError $e) {
					$ggggggggg[] = '0';
				}
				?>
			...
			<tbody>
				<tr>
					...
					<td class="align-top text-right">
						...
						<?php dd(array_sum($ggggggggg) / count($ggggggggg)); ?>
