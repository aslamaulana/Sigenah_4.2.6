...
<div class="card-body">
	...
	<table id="example1" class="table table-bordered display nowrap table-sm">
		...
		<tbody>
			<tr>
				<?php $progres1 = $db->table('tb_simonela_progres')->getWhere([
			...
			<tr>
				<?php $progres2 = $db->table('tb_simonela_progres')->getWhere([
					'kegiatan' => $DT['rkpd_kegiatan_n'],
					'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'],
					'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],
					'opd_id' => user()->opd_id,
			...
			<tr>
				<?php $progres3 = $db->table('tb_simonela_progres')->getWhere([
					'kegiatan' => $DT['rkpd_kegiatan_n'],
					'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'],
					'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],
					'opd_id' => user()->opd_id,
			...
			<tr>
				<?php $progres4 = $db->table('tb_simonela_progres')->getWhere([
					'kegiatan' => $DT['rkpd_kegiatan_n'],
					'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'],
					'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],
					'opd_id' => user()->opd_id,
			...
			<tr>
				<?php $progres5 = $db->table('tb_simonela_progres')->getWhere([
					'kegiatan' => $DT['rkpd_kegiatan_n'],
					'kegiatan_sub' => $DT['rkpd_kegiatan_sub_n'],
					'indikator_kegiatan_sub' => $DT['rkpd_indikator_kegiatan_sub'],
					'opd_id' => user()->opd_id,
