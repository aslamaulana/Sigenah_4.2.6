...
<div class="card-body">
	...
	<form action="<?= base_url('/user/emonev/emonev/progres_indikator_create') ?>" method="POST">
		<?= csrf_field() ?>
		<div class="row">
			<div class="col">
				<table id="example1" class="table table-bordered">
					...
					<tbody>
						<?php $tb_dpa_indikator = $db->table('tb_dpa_indikator')
							...
							->getWhere(['tb_dpa_indikator.dpa_id' => $dpa_id, 'tb_dpa_indikator.tahun' => $_SESSION['tahun']])->getResultArray();
						...
						?>
							<tr>
								...
								<td class="align-center">
									...
									<input type="text" name="realisasi[]" class="form-control" maxlength="20">
								</td>
