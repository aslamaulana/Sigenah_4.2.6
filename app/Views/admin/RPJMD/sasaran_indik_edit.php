...
<div class="card-body">
	<table class="table table-bordered">
		<tr>
			...
			<td class="col-md-10"><?= $indikator['sasaran']; ?></td>
		</tr>
		<tr>
			<td class="col-md-2">Kode Sasaran:</td>
			<td class="col-md-10"><?= $indikator['kode_sasaran']; ?></td>
		</tr>
	</table><br>
	<form action="<?= base_url('/admin/rpjmd/sasaran/sasaran_indik_update') ?>" method="POST">
		<?= csrf_field() ?>
		<input type="hidden" name="id_sasaran" value="<?= $indikator['id_sasaran']; ?>">
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label>Indikator Sasaran <medium class="text-danger">*</medium></label>
					<textarea name="indikator_sasaran" class="form-control" placeholder="indikator sasaran" maxlength="300" rows="4" required><?= (old('indikator_sasaran')) ? old('indikator_sasaran') : $indikator['indikator_sasaran']; ?></textarea>
