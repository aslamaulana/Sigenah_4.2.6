...
<div class="card-body">
	<table class="table table-bordered">
		<tr>
			...
			<td class="col-md-10"><?= $indikator['tujuan']; ?></td>
		</tr>
		<tr>
			<td class="col-md-2">Kode Tujuan:</td>
			<td class="col-md-10"><?= $indikator['kode_tujuan']; ?></td>
		</tr>
	</table><br>
	<form action="<?= base_url('/admin/rpjmd/tujuan/tujuan_indik_update') ?>" method="POST">
		<?= csrf_field() ?>
		<input type="hidden" name="id_tujuan" value="<?= $indikator['id_tujuan']; ?>">
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label>Indikator Tujuan <medium class="text-danger">*</medium></label>
					<textarea name="indikator_tujuan" class="form-control" placeholder="indikator tujuan" maxlength="300" rows="4" required><?= (old('indikator_tujuan')) ? old('indikator_tujuan') : $indikator['indikator_tujuan']; ?></textarea>
