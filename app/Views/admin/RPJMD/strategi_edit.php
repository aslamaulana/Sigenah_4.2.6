...
<div class="card-body">
	<form action="<?= base_url('/admin/rpjmd/strategi/strategi_update') ?>" method="POST">
		<?= csrf_field() ?>
		<input type="hidden" name="id" value="<?= $roh['id_strategi']; ?>">
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-10">
				<div class="input-group">
					<select name="sasaran" class="form-control select2bs4" required>
						<option value="<?= $roh['sasaran_n']; ?>"><?= '[ ' . $roh['kode_sasaran'] . ' ] ' . $roh['sasaran']; ?></option>
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="input-group">
					<textarea name="strategi" class="form-control" required><?= $roh['strategi']; ?></textarea>
				</div>
			</div>
		</div>
