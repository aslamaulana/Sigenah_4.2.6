...
<div class="card-body">
	<form action="<?= base_url('/user/dpa/dpa_indikator/dpa_indikator_create') ?>" method="POST">
		<?= csrf_field() ?>
		...
		<div class="card-body row">
			<div class="col-md">
				<div class="form-group">
					...
					<textarea name="indikator" value="<?= old('indikator'); ?>" class="form-control" rows="4"></textarea>
				</div>
			</div>
			<div class="col-md">
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="target_akhir" value="<?= old('target_akhir'); ?>" class="form-control" maxlength="20">
				</div>
			</div>
		</div>
