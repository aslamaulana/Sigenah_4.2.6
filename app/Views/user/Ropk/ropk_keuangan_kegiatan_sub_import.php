...
<div class="card-body">
	<form action="<?= base_url('/user/ropk/ropk_keuangan/simpanExcel_rkpd') ?>" method="POST" enctype="multipart/form-data">
		<?= csrf_field() ?>
		<table class="table table-bordered">
			<tr>
				<td colspan="3">Import Data</td>
			</tr>
			<tr>
				...
				<td>
					<div class="input-group">
						<a href="<?= base_url('/user/ropk/ropk_keuangan/export_rkpd'); ?>">
