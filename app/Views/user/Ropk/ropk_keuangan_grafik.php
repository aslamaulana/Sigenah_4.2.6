...
<div class="card-body">
	...
	try {
		$bb1i =  round(($bb1 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb1i = '0';
	}
	try {
		$bb2i =  round(($bb2 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb2i = '0';
	}
	try {
		$bb3i =  round(($bb3 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb3i = '0';
	}
	try {
		$bb4i =  round(($bb4 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb4i = '0';
	}
	try {
		$bb5i =  round(($bb5 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb5i = '0';
	}
	try {
		$bb6i =  round(($bb6 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb6i = '0';
	}
	try {
		$bb7i =  round(($bb7 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb7i = '0';
	}
	try {
		$bb8i =  round(($bb8 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb8i = '0';
	}
	try {
		$bb9i =  round(($bb9 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb9i = '0';
	}
	try {
		$bb10i = round(($bb10 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb10i = '0';
	}
	try {
		$bb11i = round(($bb11 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb11i = '0';
	}
	try {
		$bb12i = round(($bb12 / array_sum($acu)) * 100, 2);
	} catch (DivisionByZeroError $e) {
		$bb12i = '0';
	}
	?>
	...
	<div class="card-body text-center">
		<h5>Cantik Rencana dan Pelaksanaan Keuangan<br> Sub Kegiatan <?= $_GET['s']; ?> Tahun <?= $_SESSION['tahun']; ?><br> <?= opd()->description; ?></h5>
