...
<div class="card-body">
	<form action="<?= base_url('/user/ropk/ropk_organisasi/simpanExcel') ?>" method="POST" enctype="multipart/form-data">
		<?= csrf_field() ?>
		<input type="hidden" name="id" value="<?= $DT['id_ropk_organisasi_rkpd_kegiatan_sub']; ?>">
		<table class="table table-bordered">
			<tr>
				<td colspan="3">Tambah Data RKO Dari File Excel</td>
			</tr>
			<tr>
				...
				<td>
					<div class="input-group">
						<a href="<?= base_url('/user/ropk/ropk_organisasi/export?k=' . $DT['rkpd_kegiatan_n'] . '&s=' . $DT['rkpd_kegiatan_sub_n']); ?>">
...
<div class="card-body">
	<form action="<?= base_url('/user/ropk/ropk_organisasi/simpanExcel_edit') ?>" method="POST" enctype="multipart/form-data">
		<?= csrf_field() ?>
		<input type="hidden" name="id" value="<?= $DT['id_ropk_organisasi_rkpd_kegiatan_sub']; ?>">
		<table class="table table-bordered">
			<tr>
				<td colspan="3">Ubah Data RKO ( <?= $DT['rkpd_kegiatan_sub_n']; ?> )</td>
			</tr>
			<tr>
				<td style="width:120px;">Tahap 1 -> </td>
				<td style="width:220px;">Download Format Excel</td>
				<td>
					<div class="input-group">
						<a href="<?= base_url('/user/ropk/ropk_organisasi/export_edit?k=' . $DT['rkpd_kegiatan_n'] . '&s=' . $DT['rkpd_kegiatan_sub_n']); ?>">
							<li class="btn btn-block btn-success btn-sm" active><i class="nav-icon fa fa-file-excel"></i> Format</li>
						</a>
					</div>
				</td>
