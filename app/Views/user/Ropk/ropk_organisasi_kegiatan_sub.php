...
<div class="card-body">
	<form action="<?= base_url('/user/ropk/ropk_kegiatan_sub/delete_organisasi'); ?>" method="POST">
				...
				foreach ($rkpd_kegiatan as $rol) : ?>
					...
					foreach ($query as $ros) : ?>
						<tr>
							...
							<td class="align-top text-right"><?= number_format($ros['rp_tahun'], 2, ',', '.'); ?></td>
							<td style="text-align: center;">
								<a class="btn btn-info btn-circle btn-xs" href="<?= base_url() . '/user/ropk/ropk_organisasi/organisasi/' . $ros['id_ropk_organisasi_rkpd_kegiatan_sub']; ?>">
