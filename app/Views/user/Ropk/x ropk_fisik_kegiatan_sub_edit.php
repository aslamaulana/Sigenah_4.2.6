...
<div class="card-body">
	<form action="<?= base_url('/user/ropk/ropk_fisik/ropk_fisik_kegiatan_sub_update') ?>" method="POST">
		<?= csrf_field() ?>
		<input type="hidden" value="<?= $indik['id_ropk_fisik_rkpd_kegiatan_sub']; ?>" name="id">
		<div class="row">
			<div class="col-md-6">
