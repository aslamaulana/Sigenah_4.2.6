...
<div class="card-body">
	<form action="<?= base_url('/user/ropk/ropk_keuangan/simpanExcel') ?>" method="POST" enctype="multipart/form-data">
		<?= csrf_field() ?>
			...
			<tr>
				...
				<td>
					<div class="input-group">
						<a href="<?= base_url('/user/ropk/ropk_keuangan/export?k=' . $DT['rkpd_kegiatan_n'] . '&s=' . $DT['rkpd_kegiatan_sub_n']); ?>">
...
<div class="card-body">
	<form action="<?= base_url('/user/ropk/ropk_keuangan/simpanExcel_edit') ?>" method="POST" enctype="multipart/form-data">
		<?= csrf_field() ?>
		<input type="hidden" name="id" value="<?= $DT['id_ropk_keuangan_rkpd_kegiatan_sub']; ?>">
		<table class="table table-bordered">
			<tr>
			...
			<tr>
				...
				<td>
					<div class="input-group">
						<a href="<?= base_url('/user/ropk/ropk_keuangan/export_edit?k=' . $DT['rkpd_kegiatan_n'] . '&s=' . $DT['rkpd_kegiatan_sub_n']); ?>">
							<li class="btn btn-block btn-success btn-sm" active><i class="nav-icon fa fa-file-excel"></i> Format</li>
						</a>
					</div>
				</td>
