...
<div class="card-body">
	...
	<form action="<?= base_url('/user/ropk/ropk_keuangan/keuangan_update') ?>" method="POST">
		<?= csrf_field() ?>
		<input type="hidden" name="id_sub" value="<?= $DT['id_ropk_keuangan_rkpd_kegiatan_sub']; ?>">
		<input type="hidden" name="id" value="<?= $keuangan['id_ropk_keuangan']; ?>">
		<input type="hidden" name="kegiatan" value="<?= $keuangan['rkpd_kegiatan']; ?>">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Januari </div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b1']; ?>' name="b1" id="b1" onkeyup="sum1();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Februari</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b2']; ?>' name="b2" id="b2" onkeyup="sum2();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Maret</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b3']; ?>' name="b3" id="b3" onkeyup="sum3();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan April</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b4']; ?>' name="b4" id="b4" onkeyup="sum4();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Mei</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b5']; ?>' name="b5" id="b5" onkeyup="sum5();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Juni</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b6']; ?>' name="b6" id="b6" onkeyup="sum6();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Juli</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b7']; ?>' name="b7" id="b7" onkeyup="sum7();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Agustus</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b8']; ?>' name="b8" id="b8" onkeyup="sum8();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan September</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b9']; ?>' name="b9" id="b9" onkeyup="sum9();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Oktober</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b10']; ?>' name="b10" id="b10" onkeyup="sum10();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan November</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b11']; ?>' name="b11" id="b11" onkeyup="sum11();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group row">
					<div class="col-md-12">Rencama Bulan Desember</div>
					<div class="col-md-12">
						<input type="number" step="any" value='<?= $keuangan['b12']; ?>' name="b12" id="b12" onkeyup="sum12();" class="form-control" maxlength="20">
					</div>
				</div>
			</div>
		</div>
