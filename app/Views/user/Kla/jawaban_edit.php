...
<section class="content">
	...
	<div class="card shadow <?= !isset($_SESSION['max']) ? '' : $_SESSION['max']; ?>">
		...
		<div class="card-body">
			<form action="<?= base_url('/user/kla/pertanyaan/jawaban_update') ?>" method="POST" enctype="multipart/form-data">
				<?= csrf_field() ?>
				<input type="hidden" name="id_kla_jawaban" value="<?= $jawaban['id_kla_jawaban']; ?>">
					...
					<div class="col-md-10">
						<div class="input-group">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="jawaban" id="inlineRadio1" <?= $jawaban['kla_jawaban'] == 'YA' ? 'checked' : ''; ?> value="YA">
								<label class="form-check-label" for="inlineRadio1">Ada</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="jawaban" id="inlineRadio2" <?= $jawaban['kla_jawaban'] == 'TIDAK' ? 'checked' : ''; ?> value="TIDAK">
					...
					<div class="col-md-10">
						<div class="input-group">
							<div class="custom-file">
								...
								<label class="custom-file-label"><?= $jawaban['kla_jawaban_doc'] == '' ? 'Pilih dokumen' : $jawaban['kla_jawaban_doc']; ?></label>
								<input type="hidden" name="jawaban_doc-lama" value="<?= $jawaban['kla_jawaban_doc']; ?>">
								<input type="hidden" name="jawaban_doc_size-lama" value="<?= $jawaban['kla_jawaban_doc_size']; ?>">
							</div>
						</div>
