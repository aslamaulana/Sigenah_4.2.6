...
<div class="card-body">
	<table class="table table-bordered">
		<tr>
			...
			<td class="col-md-10"><?= $indik['opd_kegiatan_n']; ?></td>
		</tr>
	</table><br>
	<form action="<?= base_url('/user/renstra/opd_kegiatan/opd_kegiatan_indik_update') ?>" method="POST">
		<?= csrf_field() ?>
		<input type="hidden" value="<?= $indik['id_opd_kegiatan']; ?>" name="id">
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label>Indikator Kegiatan <medium class="text-danger">*</medium></label>
					<textarea name="indikator_kegiatan" class="form-control" placeholder="indikator kegiatan" maxlength="300" rows="4" required><?= (old('indikator_kegiatan')) ? old('indikator_kegiatan') : $indik['opd_indikator_kegiatan']; ?></textarea>
