...
<?php if ($_SESSION['perubahan'] == 'Perubahan') { ?>
	<div class="card-body">
		<form action="<?= base_url('/user/renstra/opd_sasaran/simpanExcel') ?>" method="POST" enctype="multipart/form-data">
			<?= csrf_field() ?>
			<table class="table table-bordered">
				<tr>
					<td colspan="3">Tambah Data Sasaran (import dari renstra murni)</td>
				</tr>
				<tr>
					...
					<td>
						<div class="input-group">
							<a href="<?= base_url('/user/renstra/opd_sasaran/export_perubahan'); ?>">
...
<?php } else { ?>
	<div class="card-body">
		<form action="<?= base_url('/user/renstra/opd_sasaran/simpanExcel') ?>" method="POST" enctype="multipart/form-data">
			...
			<table class="table table-bordered">
				<tr>
					<td colspan="3">Tambah Data Sasaran</td>
				</tr>
				<tr>
					<td style="width:120px;">Tahap 1 -> </td>
					<td style="width:220px;">Download Format Excel</td>
					<td>
						<div class="input-group">
							<a href="<?= base_url('/user/renstra/opd_sasaran/export'); ?>">
								<li class="btn btn-block btn-success btn-sm" active><i class="nav-icon fa fa-file-excel"></i> Format</li>
							</a>
						</div>
					</td>
...
<div class="card-body">
	<form action="<?= base_url('/user/renstra/opd_sasaran/simpanExcel_edit') ?>" method="POST" enctype="multipart/form-data">
		<?= csrf_field() ?>
		<table class="table table-bordered">
			<tr>
				<td colspan="3">Ubah Data Sasaran</td>
			</tr>
			<tr>
				<td style="width:120px;">Tahap 1 -> </td>
				<td style="width:220px;">Download Format Excel</td>
				<td>
					<div class="input-group">
						<a href="<?= base_url('/user/renstra/opd_sasaran/export_edit'); ?>">
							<li class="btn btn-block btn-success btn-sm" active><i class="nav-icon fa fa-file-excel"></i> Format</li>
						</a>
					</div>
				</td>
