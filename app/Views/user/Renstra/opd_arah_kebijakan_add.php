...
<div class="card-body">
	<form action="<?= base_url('/user/renstra/opd_arah_kebijakan/opd_arah_kebijakan_create') ?>" method="POST">
		<?= csrf_field() ?>
		<div class="row">
			<div class="col-md-2">
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="input-group">
					<textarea name="opd_arah_kebijakan" class="form-control" maxlength="300" required></textarea>
				</div>
			</div>
		</div>
