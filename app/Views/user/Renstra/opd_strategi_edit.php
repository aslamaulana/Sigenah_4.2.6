...
<div class="card-body">
	<form action="<?= base_url('/user/renstra/opd_strategi/opd_strategi_update') ?>" method="POST">
		<?= csrf_field() ?>
		<input type="hidden" name="id" value="<?= $roh['id_opd_strategi']; ?>">
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-10">
				<div class="input-group">
					<select name="sasaran" class="form-control select2bs4" required>
						<option value='{"kode":"<?= $roh['opd_kode_sasaran']; ?>","sasaran":"<?= $roh['opd_sasaran']; ?>"}'><?= '[ ' . $roh['opd_kode_sasaran'] . ' ] ' . $roh['opd_sasaran']; ?></option>
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="input-group">
					<textarea name="strategi" class="form-control" required><?= $roh['opd_strategi']; ?></textarea>
				</div>
			</div>
		</div>
