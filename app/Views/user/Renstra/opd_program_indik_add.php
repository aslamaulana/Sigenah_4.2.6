...
<div class="card-body">
	<table class="table table-bordered">
		<tr>
			...
			<td class="col-md-10"><?= $program; ?></td>
		</tr>
	</table><br>
	<form action="<?= base_url('/user/renstra/opd_program/opd_program_indik_create') ?>" method="POST">
		<?= csrf_field() ?>
		<input type="hidden" value="<?= $program; ?>" name="program">
		<input type="hidden" value="<?= $sasaran; ?>" name="sasaran">
		<input type="hidden" value="<?= $sasaran_program; ?>" name="sasaran_program">
		<div class="row">
			<div class="col-md-6">
