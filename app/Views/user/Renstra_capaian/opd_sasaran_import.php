...
<div class="card-body">
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td style="width:220px;">Import Renstra Sasaran</td>
			<td>
				<div class="input-group">
					<a onclick="if(confirm('Import Sasaran Renstra ??')){location.href='<?= base_url() . '/user/renstra_capaian/opd_capaian_sasaran/import_sasaran'; ?>'}" href="#">
...
<div class="card-body">
	<form action="<?= base_url('/user/renstra_capaian/opd_capaian_sasaran/simpanExcel_edit') ?>" method="POST" enctype="multipart/form-data">
		<?= csrf_field() ?>
		<table class="table table-bordered">
			<tr>
			...
			<tr>
				...
				<td>
					<div class="input-group">
						<a href="<?= base_url('/user/renstra_capaian/opd_capaian_sasaran/export_edit'); ?>">
