...
<div class="card-body">
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td style="width:220px;">Import Renstra Program</td>
			<td>
				<div class="input-group">
					<a onclick="if(confirm('Import Program Renstra ??')){location.href='<?= base_url() . '/user/renstra_capaian/opd_capaian_program/import_program'; ?>'}" href="#">
...
<div class="card-body">
	<form action="<?= base_url('/user/renstra_capaian/opd_capaian_program/simpanExcel_edit') ?>" method="POST" enctype="multipart/form-data">
		<?= csrf_field() ?>
		<table class="table table-bordered">
			<tr>
			...
			<tr>
				...
				<td>
					<div class="input-group">
						<a href="<?= base_url('/user/renstra_capaian/opd_capaian_program/export_edit'); ?>">
